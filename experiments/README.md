...
For the current manuscript ablation planning and handoff notes, see:
...
├── spmf.jar            # Download from SPMF website
└── README.md           # This file
```

## Dataset Downloads

Download from [SPMF Dataset Repository](http://www.philippe-fournier-viger.com/spmf/index.php?link=datasets.php):
