...
A concise paper-level positioning statement is: “TriBack-Clo is a principled itemset generalization within the BIDE paradigm, not a new mining paradigm; its novelty is the missing itemset BackScan theory and provably safe witness integration.”
